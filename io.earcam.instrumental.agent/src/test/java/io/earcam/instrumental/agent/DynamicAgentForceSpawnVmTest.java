...
import static io.earcam.instrumental.agent.Attach.PROPERTY_FORCE_ATTACH_TO_SELF;
...
import io.earcam.acme.BadAgent;
import io.earcam.instrumental.reflect.Resources;
import io.earcam.unexceptional.Exceptional;

public class DynamicAgentForceSpawnVmTest {
	...
	{
		System.setProperty(PROPERTY_FORCE_ATTACH_TO_SELF, TRUE.toString());
	}
	...
	{
		System.setProperty(PROPERTY_FORCE_ATTACH_TO_SELF, FALSE.toString());
	}
	...
	{
		jarFile = Paths.get(".", "target", DynamicAgentForceSpawnVmTest.class.getCanonicalName(), randomUUID().toString(), "dynamic-agent-test_stub-agent.jar");
	...
	@Test
	public void spawnedVmFailsWhenSuppliedClassDoesNotHaveAgentMain() throws IOException
	{
		try {
			DynamicAgent.loadAgent(BadAgent.class, "arbitrary.arguments=go.here");
			fail();
